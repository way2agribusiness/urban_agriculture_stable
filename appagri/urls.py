...
urlpatterns = [
	...
	path('kcenter/', views.kcenter_categories, name="kcenter"),
    path('kcenter/<slug:category_slug>/', views.kcenter_selected_categories, name="kcenter-category"),
    path('kcenter/<slug:category_slug>/<slug:topic_slug>/', views.kcenter_selected_topic, name="kcenter-topic"),
